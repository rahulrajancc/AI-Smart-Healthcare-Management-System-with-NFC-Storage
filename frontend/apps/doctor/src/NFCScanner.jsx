              ...
              <div className="scan-results">
                ...
                <div className="data-display">
                  <div className="raw-data">
                    ...
                    {/* <strong></strong> */}
                   {/* DATA:#jiu786#2026-03-01;Amoxicillin;1day;DRR */}
                  
                   <div className='Pat_data'><strong>Patient ID:</strong> {scannedData.split('#')[1]}</div>
                      <div className='Heal_data'><strong>Health Data:</strong> {scannedData.split('#')[2].split(';').join(', ')}</div>
